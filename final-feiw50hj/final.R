...
name <- "Nga Pui Leung"
github.name <- "ngapuileung"
email.address <- "ngapui.leung@berkeley.edu"
...
set.seed(344)
#m <- <your code here>
m <- matrix(rnorm(100, mean = 8), byrow = FALSE)
...
# 
# t2 <- <your code here>
infants.college <- infants[infants$ed == "College", ]
t2 <- table(infants.college$smoke, infants.college$number)
...
plot(mtcars$wt, mtcars$disp, xlab = "Weight of Car in lb/1000", ylab = "Engine Displacement in cu. in.")
...
plot(WorldBank$fertility.rate, WorldBank$life.expectancy, pch = ".",
     xlab = "Fertility Rate", ylab = "Life Expectancy", col = c("red", "orange", "green", "navy"))
abline(v = 2.1)
...
par(mfrow = c(2, 2))
WorldBank.1960 <- WorldBank[WorldBank$year == 1960, ]
WorldBank.2013 <- WorldBank[WorldBank$year == 2013, ]
plot(WorldBank.1960$fertility.rate, WorldBank.1960$life.expectancy, pch = ".",
     xlab = "Fertility Rate", ylab = "Life Expectancy",
     col = c("red", "orange", "green", "navy"))
plot(WorldBank.2013$fertility.rate, WorldBank.2013$life.expectancy, pch = ".",
     xlab = "Fertility Rate", ylab = "Life Expectancy",
     col = c("red", "orange", "green", "navy"))
...
WorldBank.IDA <- WorldBank[WorldBank$lending == "IDA", ]
hist(WorldBank.IDA$GDP.per.capita.Current.USD, breaks = 250, xlab = "GDP for IDA Lending Ratings", main = "Histogram for GDP of IDA Lending Ratings")
